$(function () {
    ...
    $(window).scroll(function(){
        ...
        //(scr /2) : 현재 스크롤 위치를 2로 나눈값을 의미
        //스크롤 위치에 따라 동적으로 계산된 값에 따라 위치이동
        //스크롤 위치가 증가하면 (scr /2)값도 증가
        //스크롤 위치가 감소하면 (scr /2)값도 감소됨 따라서 동적으로 보임
        ...
        // 레드카펫2
        //스크롤위치가 1630px 이상인 경우 추가 스타일 적용
        //scr 1630px보다 큰지 확인 후 해당 조건이 참일 경우 scr에서 1630px 빼줌
        //상단의 레드카펫 구조와 동일하게 동작하게 해주기위함
        if(scr >1630) {
            scr -= 1630;
            $("#redcarpet2").css({
